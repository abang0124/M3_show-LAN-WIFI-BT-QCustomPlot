...
Rectangle {
    ...
    height: 632
    color:"#d8d8d8"
    signal narrowThresHoldReturn                              //窄阈值界面返回信号
    signal narrowTurnToHeartRatePage                          //跳转至心律阈值界面
    signal narrowTurnToBloodPressurePage                      //跳转至血压阈值界面
    signal narrowTurnToSPO2Page                               //跳转至血氧阈值界面
    Rectangle {
