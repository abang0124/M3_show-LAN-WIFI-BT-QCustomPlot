...
QT_MOC_LITERAL(10, 160, 16), // "BPStartORStopSig"
QT_MOC_LITERAL(11, 177, 11), // "sendMessage"
QT_MOC_LITERAL(12, 189, 3), // "buf"
QT_MOC_LITERAL(13, 193, 18), // "clientDisconnected"
QT_MOC_LITERAL(14, 212, 15), // "clientConnected"
QT_MOC_LITERAL(15, 228, 10) // "readSocket"
    ...
    "BPStartORStopSig\0sendMessage\0buf\0"
    "clientDisconnected\0clientConnected\0"
    "readSocket"
};
...
void BluetoothServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: _t->BPStartORStopSig((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 7: _t->sendMessage((*reinterpret_cast< const QByteArray(*)>(_a[1]))); break;
        ...
        {
            using _t = void (BluetoothServer::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BluetoothServer::BPStartORStopSig)) {
                *result = 6;
                return;
            }
        }
...
// SIGNAL 6
void BluetoothServer::BPStartORStopSig(bool _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
